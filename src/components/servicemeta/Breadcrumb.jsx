  ...
  return (
    <>
      ...
      <div className="layer-shape wow fadeInLeft" data-wow-delay=".3s" style={{ visibility: 'visible', animationDelay: '.3s', animationName: 'fadeInLeft' }}>
        <img src="./src/asstes/img/layer-shape-3.webp" alt="shape-img" />
      </div>
      ...
      <div className="container">
        <div className="page-heading">
          <h1 className="wow fadeInUp" data-wow-delay=".3s" style={{ visibility: 'visible', animationDelay: '.3s', animationName: 'fadeInUp' }}>Meta Ads</h1>
